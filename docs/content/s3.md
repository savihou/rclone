...
{{< provider name="Zadara" home="https://www.zadara.com/" config="/s3/#zadara" end="true" >}}
{{< /provider_list >}}
...
```
env_auth> 1
access_key_id> 262bca8839744d7087833b491eb5d36a
secret_access_key> MYSECRETS3ACCESSKEY
region> us-east-1
endpoint> https://vsa-00000099-zadara-us-east-01.zadarazios.com
location_constraint>
acl>
```
...
So once set up, for example, to copy files into a new bucket:

```
rclone mkdir zadara:bucket
rclone copy /path/to/files zadara:bucket
```